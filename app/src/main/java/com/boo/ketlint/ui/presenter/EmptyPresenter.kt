...
import com.boo.ketlint.ui.model.EmptyModel
 ...
 **/
class EmptyPresenter : BaseMvpPresenter<EmptyContract.IView, EmptyContract.IModel>(), EmptyContract.IPresenter {

    private var mPage = 1

    override fun registerModel() = EmptyModel::class.java
