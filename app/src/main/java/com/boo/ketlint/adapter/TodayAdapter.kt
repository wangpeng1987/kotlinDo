 ...
 * @author
 */
class TodayAppAdapter(mContext: Context, mData: MutableList<App>) : LoadMoreRecyclerAdapter<App>(mContext, mData) {
 ...
 * @author
 */
class TodayIOSAdapter(mContext: Context, mData: MutableList<IOS>) : LoadMoreRecyclerAdapter<IOS>(mContext, mData) {
 ...
 * @author
 */
class Today休息视频Adapter(mContext: Context, mData: MutableList<休息视频>) : LoadMoreRecyclerAdapter<休息视频>(mContext, mData) {
 ...
 * @author
 */
class Today前端Adapter(mContext: Context, mData: MutableList<前端>) : LoadMoreRecyclerAdapter<前端>(mContext, mData) {
 ...
 * @author
 */
class Today拓展资源Adapter(mContext: Context, mData: MutableList<拓展资源>) : LoadMoreRecyclerAdapter<拓展资源>(mContext, mData) {
 ...
 * @author
 */
class Today瞎推荐Adapter(mContext: Context, mData: MutableList<瞎推荐>) : LoadMoreRecyclerAdapter<瞎推荐>(mContext, mData) {
 ...
 * @author
 */
class Today福利Adapter(mContext: Context, mData: MutableList<福利>) : LoadMoreRecyclerAdapter<福利>(mContext, mData) {
